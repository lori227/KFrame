...
call :copyfile 1 dir.setting

rem 配置目录
set path1=..\..\Server\_bin\setting\dir
set path2=setting
...
call :copyfile 1 KFDirProxyd.dll
call :copyfile 1 KFDirProxy.dll
call :copyfile 1 KFDirShardd.dll
call :copyfile 1 KFDirShard.dll
