                                   ...
                                   <!-- <form class="" action="" method="post">-->
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="btn-group col-md-6" >
                                                    <textarea class=" col-md-12" style="height:200px;" placeholder="玩家列表（每行一个玩家ID）" name="playerList" disabled><?php if(isset($redisEmail)){foreach($redisEmail as $ary){echo $ary."\r\n";}}?></textarea>
                                                </div>
