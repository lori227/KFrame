        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <textarea class=" col-md-12" style="height:300px;" placeholder="请输入邮件内容" name="playerList"><?php if(!empty($redisEmail)){foreach($redisEmail as $ary){echo $ary."\r\n";}}?></textarea>
                </div>
                                    ...
                                    <form class="form-horizontal" action="" method="post" id="mailForm">
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="btn-group col-md-6" >
                                                    <label><input  type="radio" class="emailType" name="type" value="1" checked />全局邮件</label>&nbsp;&nbsp;
                                                    ...
                                                    <a data-toggle="modal" data-target="#mymodal-data2" href="javascript:void(0)" class="tooltip-show" data-toggle="tooltip" data-placement="right" title="<?php echo implode('，',$redisEmail);?>">（用户ID上传）</a>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                   <textarea class="from-control col-md-12" placeholder="请输入邮件内容（自动过滤%）" name="content" style="height:100px;"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
