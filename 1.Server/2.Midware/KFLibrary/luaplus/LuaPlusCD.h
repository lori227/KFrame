...
//#endif // _WIN64
	...
	template<> struct Type<long long> {
		static inline void Push( lua_State* L, long long value ) { lua_pushnumber( L, (lua_Number)value ); }
		static inline bool Match( lua_State* L, int idx ) { return lua_type( L, idx ) == LUA_TNUMBER; }
		static inline long long Get( lua_State* L, int idx ) { return static_cast<long long>(lua_tonumber( L, idx )); }
	};
	...
	template<> struct Type<unsigned long long> {
		static inline void Push( lua_State* L, unsigned long long value ) { lua_pushnumber( L, (lua_Number)value ); }
		static inline bool Match( lua_State* L, int idx ) { return lua_type( L, idx ) == LUA_TNUMBER; }
		static inline unsigned long long Get( lua_State* L, int idx ) { return static_cast<unsigned long long>(lua_tonumber( L, idx )); }
	};
