...
namespace KFrame
{
    ...
    protected:
        ...
        KFFunctionMap< std::string, KFCmdFunction > _command_functions;

        // 注册的Run函数
        KFFunctionMap< uint32, KFRunFunction > _run_functions;
        KFFunctionMap< uint32, KFRunFunction > _after_run_functions;
    };
}
