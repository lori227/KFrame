			...
			<div id="content">
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-pencil-square-o fa-fw"></i><?php echo isset($is_modify)?'修改':'添加';?>IP</h1>
					</div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2" >
                                                        <select class="form-control" name="status">
                                                            ...
                                                            <option value="1" <?php echo isset($status)&& $status==1?'selected':null; ?>>开启</option>
                                                            <option value="2" <?php echo isset($status)&& $status==2?'selected':null; ?>>关闭</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input class="form-control" placeholder="0.0.0.0形式" type="text" name="ip"  maxlength="16" value="<?php echo $ip??null;?>" <?php echo isset($is_modify)?'readonly':null ?> />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">原因描述</label>
                                                    <div class="col-md-2">
                                                        <textarea class="form-control" placeholder="限制的原因" name="reason" style="height:80px;"><?php echo $reason??null;?></textarea>
                                                    </div>
                                                </div>
                                            </fieldset>
