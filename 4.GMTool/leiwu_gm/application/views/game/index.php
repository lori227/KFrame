...
<?php $this->load->view('left');?>
    <div role="main" id="main">
        <?php $this->load->view('right-nav', array('navTitle' => array('平台管理', '游戏列表')));?>
        <!-- MAIN CONTENT -->
        <div id="content">

            <div class="row">
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                    <h1 class="page-title txt-color-blueDark"><i class="fa fa-lg fa-fw fa-list-alt"></i>游戏列表</h1>
                </div>
                        ...
                        <div class="jarviswidget jarviswidget-color-white jarviswidget-sortable" style="" role="widget">
                            ...
                            <header role="heading">
                                <div class="jarviswidget-ctrls" role="menu">
                                    <a data-placement="bottom" href="/game/add" title="" rel="tooltip" class="button-icon jarviswidget-delete-btn">&nbsp;&nbsp;<i class="fa fa-plus"></i>&nbsp;添加游戏&nbsp;&nbsp;</a>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <?php if(isset($data)){foreach($data as $v){?>
                                            <tr id="<?=$v['id'];?>">
                                               ...
                                               <!-- <td><a href="/game/modify/<?/*=$v['id'];*/?>" class="btn btn-info">修改</a></td>-->
                                            </tr>
                                        <?php }}?>
                                        </tbody>
                                    </table>
