...
<? $this->load->view('left');?>
    <div role="main" id="main">
        <? $this->load->view('right-nav', array('navTitle' => array('平台管理', '白名单')));?>
        <!-- MAIN CONTENT -->
        <div id="content">

            <div class="row">
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                    <h1 class="page-title txt-color-blueDark"><i class="fa fa-lg fa-fw fa-list-alt"></i> 白名单</h1>
                </div>
                        ...
                        <div class="jarviswidget jarviswidget-color-white jarviswidget-sortable" style="" role="widget">
                            ...
                            <header role="heading">
                                <div class="jarviswidget-ctrls" role="menu">
                                    <a data-placement="bottom" href="/white/add" title="" rel="tooltip" class="button-icon jarviswidget-delete-btn">&nbsp;&nbsp;<i class="fa fa-plus"></i>&nbsp;添加白名单&nbsp;&nbsp;</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <?php if(isset($data)){foreach($data as $v){?>
                                            <tr id="<?=$v['id'];?>">
                                                ...
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;<?=$v['is_allow_login'];?></td>

                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;<?=$users[$v['add_user']];?></td>
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;<?=date('Y-m-d H:i:s',$v['add_time']);?></td>

                                                <td>
                                                    <a href="/white/modify/<?=$v['id'];?>" class="btn btn-info">修改</a>
                                                   <a href="/white/delete/<?=$v['id'];?>" class="btn btn-danger">删除</a>
                                                </td>
                                            </tr>
                                        <?php }}?>
                                        </tbody>
