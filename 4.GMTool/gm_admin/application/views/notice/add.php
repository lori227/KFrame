...
<?=$this->load->view('left');?>
    ...
    <script src="<?=STATIC_RESULT_SRC;?>js/plugin/summernote/summernote.js"></script>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6" >
                                                    <select class="form-control" name="type">
                                                        ...
                                                        <option value="1" <?php if($type=='1'){echo 'selected';}?>>登陆前公告</option>
                                                        <option value="2" <?php if($type=='2'){echo 'selected';}?>>登陆后公告</option>
                                                        <option value="3" <?php if($type=='3'){echo 'selected';}?>>跑马灯</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </fieldset>
