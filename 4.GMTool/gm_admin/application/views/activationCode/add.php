			...
			<div id="content">
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-pencil-square-o fa-fw"></i>生成激活码</h1>
					</div>
                            ...
                            <div class="jarviswidget jarviswidget-color-white jarviswidget-sortable" style="" role="widget">
                                ...
                                <header role="heading">
                                    <div class="jarviswidget-ctrls" role="menu">
                                        <a data-placement="bottom" href="/activationCode" title="" rel="tooltip" class="button-icon jarviswidget-delete-btn" data-original-title="">&nbsp;&nbsp;<i class="fa fa-plus"></i>&nbsp;返回列表&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    </div>
                                    ...
                                    <div class="widget-body">
                                        <form class="form-horizontal" action="" method="post" id="codeFrom" onsubmit="return check()">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">本次生成个数</label>
                                                    <div class="col-md-1">
                                                        <input class="form-control" placeholder="1000以内" type="text" name="num" id="num" value="10"/>
                                                    </div>
                                                </div>
                                            </fieldset>
