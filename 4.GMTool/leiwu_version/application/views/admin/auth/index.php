                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <?php if(isset($list) && $list){foreach($list as $v){?>
                                            <tr id="<?=$v['id'];?>">
                                                ...
                                                <td>&nbsp;&nbsp;<a class="btn btn-labeled btn-default" href="/admin/auth/edit/pass/<?=$v['id'];?>"> <span class="btn-label"><i class="fa fa-pencil-square-o"></i></span>修改密码</a>&nbsp;&nbsp;<a class="btn btn-labeled btn-primary" href="/admin/auth/edit/auth/<?=$v['id'];?>"> <span class="btn-label"><i class="fa fa-gear"></i></span>权限设置</a>&nbsp;&nbsp;
                                                <?php if($v['status'] == 1){ ?>
