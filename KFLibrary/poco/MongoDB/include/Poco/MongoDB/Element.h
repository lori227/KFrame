...
namespace Poco {
    namespace MongoDB {
        ...
        template<>
        struct ElementTraits<UInt32>
        {
            enum { TypeId = 0x10 };

            static std::string toString( const UInt32& value, int indent = 0 )
            {
                return Poco::NumberFormatter::format( value );
            }
        };
        ...
        template<>
        struct ElementTraits<UInt64>
        {
            enum { TypeId = 0x12 };

            static std::string toString( const UInt64& value, int indent = 0 )
            {
                return NumberFormatter::format( value );
            }
        };
