...
"%VS150COMNTOOLS%..\IDE\Devenv" gperftools.sln /rebuild "Debug|X64" /project libtcmalloc_minimal
...
"%VS150COMNTOOLS%..\IDE\Devenv" gperftools.sln /rebuild "Release-Patch|X64" /project libtcmalloc_minimal
