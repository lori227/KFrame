...
namespace LPCD {
    ...
    template<> struct Type<long long> {
        ...
        static inline long long Get( lua_State* L, int idx ) {
            return static_cast<long long>( lua_tonumber( L, idx ) );
        }
    };
    template<> struct Type<long long&> : public Type<long long> {};
    template<> struct Type<const long long&> : public Type<long long> {};
    ...
    template<> struct Type<unsigned long long> {
        ...
        static inline unsigned long long Get( lua_State* L, int idx ) {
            return static_cast<unsigned long long>( lua_tonumber( L, idx ) );
        }
    };
    ...
    template<int NUM_CHARS> struct Type<char [NUM_CHARS]> {
        static inline void Push( lua_State* L, const char value[NUM_CHARS] )				{
            lua_pushstring( L, value );
        }
        static inline bool Match( lua_State* L, int idx )									{
            return lua_type( L, idx ) == LUA_TSTRING;
    ...
    template<> struct Type<const LuaNil&> {
        static inline void Push( lua_State* L, const LuaNil& value )						{
            lua_pushnil( L );
        }
        static inline bool Match( lua_State* L, int idx )									{
            return true;
        }
        static inline LuaNil Get( lua_State* L, int idx )									{
            ( void )L, ( void )idx;
            return LuaNil();
        }
    };
    ...
    template<> struct Type<lua_CFunction> {
        static inline void Push( lua_State* L, const lua_CFunction value )				{
    ...
    template<> struct Type<void*> {
        static inline void Push( lua_State* L, const void* value )						{
    ...
    template<> struct Type<const LuaLightUserdata&> {
        static inline void Push( lua_State* L, const LuaLightUserdata& value )			{
            lua_pushlightuserdata( L, ( void* )value.m_value );
        }
        static inline bool Match( lua_State* L, int idx )									{
            return lua_type( L, idx ) == LUA_TLIGHTUSERDATA;
        }
    ...
    template<> struct Type<LuaUserdata> {
        static inline void Push( lua_State* L, LuaUserdata value )						{
            *( void** )( lua_newuserdata( L, sizeof( void* ) ) ) = ( void* )value.m_value;
        }
        static inline bool Match( lua_State* L, int idx )									{
    ...
    inline void Push( lua_State* L, const char* value, int len )							{
