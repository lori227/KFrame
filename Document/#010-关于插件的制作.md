...
***
	使用启动器启动, 并加载新的插件配置
	命令行中输入:
	win64  start "newname" KFStartupd.exe appid=100.0.0.1 log=0.0 startup=./startup/newname.startup 
	linux ./KFStartupd appid=100.0.0.1 log=0.0 startup=./startup/ daemon=0
