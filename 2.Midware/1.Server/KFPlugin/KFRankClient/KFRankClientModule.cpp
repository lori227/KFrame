...
namespace KFrame
{
    ...
    {
        return _kf_route->SendToRand( playerid, __KF_STRING__( rank ), msgid, message );
    }
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    __KF_UPDATE_DATA_FUNCTION__( KFRankClientModule::OnDataUpdateCallBack )
    {
        ...
        if ( !kfdata->HaveFlagMask( KFDataDefine::Mask_Rank_Data ) ||
                !kfparent->HaveFlagMask( KFDataDefine::Mask_Rank_Data ) )
        {
            return;
        }

        auto& ranksettinglist = _kf_rank_config->FindRankSetting( kfparent->GetName(), kfdata->GetName() );
