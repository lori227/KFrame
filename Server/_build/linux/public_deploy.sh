...
copyfile 1 public.master.startup
copyfile 1 public.proxy.startup
copyfile 1 public.shard.startup
...
cp -f $deploypath/KFStartup $deploypath/publicserver
cp -f $deploypath/KFStartupd $deploypath/publicserverd
