...
deploypath=/data/upload/deploy/mailcluster/linux
...
path1=$versionpath/setting/mail
...
path1=$versionpath
path2=$deploypath
copyfile 1 KFStartup mailserver
copyfile 1 KFStartupd mailserverd
...
#upload to ftp
curl -sd '{"ftpid":'$2',"apppath":"mailcluster"}' $3
