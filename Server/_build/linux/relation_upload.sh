...
deploypath=/data/upload/deploy/relationcluster/linux
...
path1=$versionpath/setting/relation
...
path1=$versionpath
path2=$deploypath
copyfile 1 KFStartup relationserver
copyfile 1 KFStartupd relationserverd
...
#upload to ftp
curl -sd '{"ftpid":'$2',"apppath":"relationcluster"}' $3
