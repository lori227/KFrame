...
deploypath=/data/upload/deploy/rank/linux
...
copyfile 1 rank.master.startup
copyfile 1 rank.proxy.startup
copyfile 1 rank.shard.startup
...
path2=$deploypath
copyfile 1 KFStartup rankserver
copyfile 1 KFStartupd rankserverd
...
#upload to ftp
curl -sd '{"ftpid":'$2',"apppath":"rank"}' $3
