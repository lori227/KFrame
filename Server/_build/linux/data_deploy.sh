...
copyfile 1 data.master.startup
copyfile 1 data.proxy.startup
copyfile 1 data.shard.startup
...
cp -f $deploypath/KFStartup $deploypath/dataserver
cp -f $deploypath/KFStartupd $deploypath/dataserverd
...
copyfile 1 KFDataProxy.so
copyfile 1 KFDataProxyd.so
copyfile 1 KFDataShard.so
copyfile 1 KFDataShardd.so
