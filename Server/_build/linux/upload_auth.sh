...
path1=$binpath
path2=$deploypath
cp -f $binpath/KFStartup $binpath/authserver
cp -f $binpath/KFStartupd $binpath/authserverd

copyfile 1 authserver
copyfile 1 authserverd
