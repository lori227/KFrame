...
deploypath=/data/upload/deploy/match/linux
...
copyfile 1 match.master.startup
copyfile 1 match.proxy.startup
copyfile 1 match.shard.startup
copyfile 1 common.startup

#config
path1=$versionpath/config
path2=$deploypath/config
copyfile 1 match.config

#plugin
path1=$versionpath/bin
path2=$deploypath
copyfile 1 KFStartup matchserver
copyfile 1 KFStartupd matchserverd
...
copyfile 1 KFMatchProxy.so
copyfile 1 KFMatchProxyd.so
copyfile 1 KFMatchShard.so
copyfile 1 KFMatchShardd.so
...
#upload to ftp
curl -sd '{"ftpid":'$2',"apppath":"match"}' $3
