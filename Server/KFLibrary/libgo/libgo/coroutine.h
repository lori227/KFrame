...
#define coroutine ::co::__go(__FILE__, __LINE__)-
...
#define go_stack(size) coroutine co_stack(size)
#define go_dispatch(thread_id_or_type) coroutine co_dispatch(thread_id_or_type)
