...
#define __EMPTY_VERSION__ "0"
    ...
    public:
        ...
        bool CheckCompatibility( std::string version )
        {
            ...
            if ( _client_version != __EMPTY_VERSION__ && _client_version != kfversion._client_version )
            {
                return false;
            }

            if ( _server_version != __EMPTY_VERSION__ && _server_version != kfversion._server_version )
            {
                return false;
            }
