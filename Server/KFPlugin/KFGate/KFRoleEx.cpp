...
{
    // 发送消息到Client
    bool KFRoleEx::SendMessageToClient( uint32 msgid, const char* data, uint32 length )
    {
        return _kf_tcp_server->SendNetMessage( _session_id, msgid, data, length );
    }

    bool KFRoleEx::SendMessageToClient( uint32 msgid, ::google::protobuf::Message* message )
    {
