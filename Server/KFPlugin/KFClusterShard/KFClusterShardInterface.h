...
namespace KFrame
{
    ...
    public:
        ...
        // 发型消息到代理服务器
        virtual bool SendToClient( uint64 proxyid, uint64 clientid, uint32 msgid, const char* data, uint32 length ) = 0;
        virtual bool SendToClient( uint64 proxyid, uint64 clientid, uint32 msgid, google::protobuf::Message* message ) = 0;

        // 发送消息到玩家
        virtual bool SendToPlayer( uint64 clientid, uint64 playerid, uint32 msgid, google::protobuf::Message* message ) = 0;

        /////////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////////
        // 注册对象映射
        virtual void AddObjectToProxy( uint64 objectid ) = 0;
        virtual void AddObjectToProxy( uint64 proxyid, const std::set< uint64 >& objectlist ) = 0;
