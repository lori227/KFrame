...
namespace KFrame
{
    ...
    void KFSkinModule::BeforeRun()
    {
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////
        //__REGISTER_MESSAGE__( KFMsg::MSG_DRESS_SKIN_REQ, &KFSkinModule::HandleDressSkinReq );
    }
    ...
    __KF_ADD_ELEMENT_FUNCTION__( KFSkinModule::AddSkinElement )
    {
        ...
        // 判断是否存在该皮肤
        auto kfskin = kfskinrecord->FindData( kfelementobject->_config_id );
        if ( kfskin == nullptr )
        {
            // 不存在, 创建新的皮肤
            ...
            // 添加皮肤
            player->AddData( kfskinrecord, kfelementobject->_config_id, kfskin );
        }
        else
        {
            // 存在, 判断有效时间
            ...
            if ( datatime != 0u )
            {
                ...
                {
                    // 添加皮肤时间
                    player->UpdateData( kfskin, __KF_STRING__( time ), KFOperateEnum::Add, elementtime );
                }
            }
            else
            {
    ...
    __KF_MESSAGE_FUNCTION__( KFSkinModule::HandleDressSkinReq )
    {
