...
namespace KFrame
{
    ...
    __KF_MESSAGE_FUNCTION__( KFRouteProxyModule::HandleRegisterZoneReq )
    {
        ...
        __LOG_INFO__( KFLogEnum::Logic, "register route server[{}=>{}]!",
    ...
    __KF_MESSAGE_FUNCTION__( KFRouteProxyModule::HandleTransmitRouteZoneMessageReq )
    {
        ...
        {
            return __LOG_ERROR__( KFLogEnum::Logic, "msgid[{}] can't select route shard!", kfmsg.transmitdata().msgid() );
        }
    ...
    __KF_MESSAGE_FUNCTION__( KFRouteProxyModule::HandleTransmitRouteProxyMessageAck )
    {
        ...
        {
            return __LOG_ERROR__( KFLogEnum::Logic, "msgid[{}] can't route server[{}]!",
