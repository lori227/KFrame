...
class Auth extends MY_Controller {
    ...
    function index() {
        ...
        $this->load->view('admin/auth/index', array('list'=>$list));
    }
    ...
    function add(){
        ...
        $this->load->view('admin/auth/add', array('data'=>$tmpData,'actName'=>'添加管理员','act'=>$act));
    }
    ...
    function addAuth(){
        ...
        $this->load->view('admin/auth/addAuth', $result);
    }
    ...
    /*    if($this->_data['data']['allow_app'] == 'all'){
        ...
        $this->load->view('admin/auth/'.$act, $data);
    }
