...
if ( ! function_exists('load_class'))
{
    function &load_class($class, $directory = 'libraries', $prefix = 'CI_')
    {
        ...
        $_classes[$class] = new $name();//var_dump($_classes[$class]);
        return $_classes[$class];
    }
}
...
if ( ! function_exists('showError'))
{
    function showError($msg)
    {
        ...
        $html = '<div class=\"alert alert-danger fade in\"><button class=\"close\" data-dismiss=\"alert\">×</button><i class=\"fa-fw fa fa-times\"></i><strong>Error!</strong> '.$msg.'.</div>';
        $error = '<script>$("#content").prepend("'.$html.'");</script>';
        echo $error;
    }
}
/**
 * 截字符串 英文一个lenght 为1 中文为3 末尾加...
 * @param $str 源字符串
 * @param $length 要保留字符串长度
 * @author chile
 */
