...
<?php $this->load->view('left');?>
    <div role="main" id="main">
        <?php $this->load->view('right-nav', array('navTitle' => array('平台管理', 'CDK礼包列表')));?>
    <div id="content">
        <div class="row">
                ...
                <table class="table table-bordered">
                    ...
                    <?php if(isset($list)){foreach($list as $v){?>
                        <tr id="<?php $v['id'];?>">
                            ...
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $frequency[$v['frequency']]??'';?></td>
                            ...
                            <td>
                                <a href="/cdkCode/modifyConfig/<?php echo $v['id'];?>" class="btn btn-default">修改</a>
                            </td>
                        </tr>
                    <?php }}?>
                    </tbody>
