#ifndef __KF_DIR_ATTRIBUTE_LOGIC_H__
#define __KF_DIR_ATTRIBUTE_LOGIC_H__

#include "KFrame.h"

namespace KFrame
{
    class KFDirAttributeLogic
    {
    public:
        KFDirAttributeLogic() = default;
        virtual ~KFDirAttributeLogic() = default;
    ...
    public:
        ...
        // 查询masterlist
        virtual StringListMap QueryMasterList( const std::string& appname, uint32 zoneid ) = 0;
    public:
        // 分配一个小区
