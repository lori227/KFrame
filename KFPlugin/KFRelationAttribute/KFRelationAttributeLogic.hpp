#ifndef __KF_RELATION_ATTRIBUTE_LOGIC_H__
#define __KF_RELATION_ATTRIBUTE_LOGIC_H__
...
namespace KFrame
{
    ...
    class KFRelationAttributeLogic
    {
    public:
        KFRelationAttributeLogic() = default;
        virtual ~KFRelationAttributeLogic() = default;
