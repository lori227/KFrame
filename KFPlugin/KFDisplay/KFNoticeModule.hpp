...
namespace KFrame
{
    ...
    public:
        ...
        ////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////
        virtual void SendToPlayer( EntityPtr player, uint32 type, uint32 count = 1u );
        virtual void SendToPlayer( DataPtr basic_data, uint32 type, uint32 count = 1u );

        virtual void SendToPlayer( const Route& route, uint32 type, uint32 count = 1u );
        virtual void SendToPlayer( uint64 server_id, uint64 player_id, uint32 type, uint32 count = 1u );
