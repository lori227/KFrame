...
#define __REGISTER_CLIENT_SHUTDOWN_FUNCTION__( function ) \
    _kf_tcp_client->RegisterShutdownFunction( this, function )

#define __UNREGISTER_CLIENT_SHUTDOWN_FUNCTION__() \
    _kf_tcp_client->UnRegisterShutdownFunction( this )

#define __REGISTER_CLIENT_FAILED_FUNCTION__( function ) \
    _kf_tcp_client->RegisterFailedFunction( this, function )

#define __UNREGISTER_CLIENT_FAILED_FUNCTION__() \
    _kf_tcp_client->UnRegisterFailedFunction( this )

#define __REGISTER_CLIENT_TRANSPOND_FUNCTION__( function ) \
    _kf_tcp_client->RegisterTranspondFunction( this, function )

#define __UNREGISTER_CLIENT_TRANSPOND_FUNCTION__() \
