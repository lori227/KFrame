...
namespace KFrame
{
    ...
    public:
        ...
        // 获得master ip
        virtual const KFNetData* GetMasterIp( const std::string& appname, uint32 zone_id ) = 0;

        // 查询master列表
        virtual const std::list< KFNetData >& GetMasterList( const std::string& appname, uint32 zone_id ) = 0;
    };
