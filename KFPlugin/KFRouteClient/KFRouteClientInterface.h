...
namespace KFrame
{
    ...
    public:
        ...
        virtual bool SendToAll( uint64 sendid, const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;

        // 转给到指定类型的所有( 失败重复发送 )
        virtual bool RepeatToAll( const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool RepeatToAll( uint64 sendid, const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        
        // 转发到随机服务器( 只发送一次 )
        virtual bool SendToRand( const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool SendToRand( uint64 sendid, const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;

        // 转发到随机服务器( 失败重复发送 )
        virtual bool RepeatToRand( const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool RepeatToRand( uint64 sendid, const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        
        // 转发到负载最小的服务器( 只发送一次 )
        virtual bool SendToBalance( const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool SendToBalance( uint64 sendid, const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;

        // 转发到负载最小的服务器( 失败重复发送 )
        virtual bool RepeatToBalance( const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool RepeatToBalance( uint64 sendid, const std::string& name, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        
        // 发送到对象所在的服务器( 只发送一次 )
        virtual bool SendToObject( const std::string& name, uint64 objectid, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool SendToObject( uint64 sendid, const std::string& name, uint64 objectid, uint32 msg_id, ::google::protobuf::Message* message ) = 0;

        // 发送到对象所在的服务器( 失败重复发送 )
        virtual bool RepeatToObject( const std::string& name, uint64 objectid, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool RepeatToObject( uint64 sendid, const std::string& name, uint64 objectid, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        
        // 转发给指定服务器( 只发送一次 )
        virtual bool SendToServer( uint64 server_id, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool SendToServer( uint64 sendid, uint64 server_id, uint32 msg_id, ::google::protobuf::Message* message ) = 0;

        // 转发给指定服务器( 失败重复发送 )
        virtual bool RepeatToServer( uint64 server_id, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        virtual bool RepeatToServer( uint64 sendid, uint64 server_id, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        
        ...
        virtual bool SendToEntity( uint64 sendid, uint64 server_id, uint64 recv_id, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        ...
        virtual bool RepeatToEntity( uint64 sendid, uint64 server_id, uint64 recv_id, uint32 msg_id, ::google::protobuf::Message* message ) = 0;
        
        // 注册连接回调
        template<class T>
