...
namespace KFrame
{
    ...
    public:
        ...
        ////////////////////////////////////////////////////////////////////////////////
        // 初始化条件
        virtual void AddCondition( EntityPtr kfentity, DataPtr kfconditionobject, const DynamicConditionGroupPtr& conditiongroup );

        // 初始化条件
        virtual bool InitCondition( EntityPtr kfentity, DataPtr kfconditionobject, bool update );

        // 直接更新条件
        virtual bool UpdateCondition( EntityPtr kfentity, DataPtr kfconditionobject, uint32 conditionid, uint32 operate, uint32 conditionvalue );

        // 判断动态计数条件
        virtual bool CheckCondition( EntityPtr kfentity, DataPtr kfconditionobject );

        // 添加属性更新条件, 返回true, 条件全部完成
        virtual bool UpdateAddCondition( EntityPtr kfentity, DataPtr kfconditionobject, DataPtr kfdata );

        // 删除属性更新条件, 返回true, 条件全部完成
        virtual bool UpdateRemoveCondition( EntityPtr kfentity, DataPtr kfconditionobject, DataPtr kfdata );

        // 更新属性更新条件, 返回true, 条件全部完成
        virtual bool UpdateUpdateCondition( EntityPtr kfentity, DataPtr kfconditionobject, DataPtr kfdata, uint32 operate, uint64 value, uint64 nowvalue );
    ...
    protected:
        ...
        // 直接更新数值
        uint32 UpdateConditionData( EntityPtr kfentity, DataPtr kfcondition, uint32 conditionid, uint32 operate, uint32 conditionvalue );

        // 添加属性更新条件, 返回true, 条件全部完成
        uint32 UpdateAddConditionData( EntityPtr kfentity, DataPtr kfcondition, DataPtr kfdata );

        // 删除属性更新条件, 返回true, 条件全部完成
        uint32 UpdateRemoveConditionData( EntityPtr kfentity, DataPtr kfcondition, DataPtr kfdata );

        // 更新条件
        uint32 UpdateUpdateConditionData( EntityPtr kfentity, DataPtr kfcondition, DataPtr kfdata, uint32 operate, uint64 value, uint64 nowvalue );
