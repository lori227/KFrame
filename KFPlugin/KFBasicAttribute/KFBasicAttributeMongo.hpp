#ifndef __KF_BASIC_ATTRIBUTE_MONGO_H__
#define __KF_BASIC_ATTRIBUTE_MONGO_H__
...
namespace KFrame
{
    class KFBasicAttributeMongo : public KFBasicAttributeLogic
    {
    public:
        KFBasicAttributeMongo() = default;
        ~KFBasicAttributeMongo() = default;
