...
namespace KFrame
{
    ...
    protected:
        ...
        // 保存数据
        virtual bool SaveData( uint32 zoneid, uint64 playerid, const std::string& playerdata ) = 0;
    ...
    protected:
        ...
        // 保存玩家数据
        virtual bool SaveData( uint32 zoneid, uint64 playerid, const std::string& playerdata );
