...
#define __RELATION_TABLE_NAME__ __STRING__( relation )
    ...
    void KFRelationDatabaseMongo::QueryRelationList( const std::string& listname, const std::string& relationname, uint64 playerid, RelationListType& relationlist )
    {
    ...
    void KFRelationDatabaseMongo::QueryInviteList( const std::string& listname, const std::string& relationname, uint64 playerid, RelationListType& relationlist )
    {
        auto mongodriver = __RELATION_MONGO_DRIVER__;
        auto kfresult = mongodriver->QueryListUInt64( __RELATION_TABLE_NAME__, playerid, listname );
    ...
    bool KFRelationDatabaseMongo::RelationExist( const std::string& listname, uint64 playerid, uint64 targetid )
    {
        auto mongodriver = __RELATION_MONGO_DRIVER__;
        auto kfresult = mongodriver->QueryListUInt64( __RELATION_TABLE_NAME__, playerid, listname );
    ...
    uint32 KFRelationDatabaseMongo::RelationCount( const std::string& listname, uint64 playerid )
    {
        auto mongodriver = __RELATION_MONGO_DRIVER__;
        auto kfresult = mongodriver->QueryListUInt64( __RELATION_TABLE_NAME__, playerid, listname );
    ...
    void KFRelationDatabaseMongo::AddRelation( const std::string& listname, const std::string& relationname, uint64 playerid, uint64 targetid, bool bothway )
    {
        auto mongodriver = __RELATION_MONGO_DRIVER__;
    ...
    void KFRelationDatabaseMongo::RemoveRelation( const std::string& listname, const std::string& relationname, uint64 playerid, uint64 targetid, bool bothway )
    {
        auto mongodriver = __RELATION_MONGO_DRIVER__;
    ...
    void KFRelationDatabaseMongo::AddInvite( const std::string& listname, const std::string& relationname, uint64 playerid, uint64 targetid, const std::string& message, uint64 keeptime )
    {
        auto mongodriver = __RELATION_MONGO_DRIVER__;
        mongodriver->Push( __RELATION_TABLE_NAME__, playerid, listname, targetid );
    ...
    bool KFRelationDatabaseMongo::IsRefuse( const std::string& refusename, uint64 playerid )
    {
        auto mongodriver = __RELATION_MONGO_DRIVER__;
    ...
    void KFRelationDatabaseMongo::SetRefuse( const std::string& refusename, uint64 playerid, uint32 refusevalue )
    {
        auto mongodriver = __RELATION_MONGO_DRIVER__;
