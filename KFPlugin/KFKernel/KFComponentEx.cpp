...
namespace KFrame
{
    ...
    void KFComponentEx::CallLogElementFunction( KFEntity* kfentity, const std::string& modulename, uint32 moduleid, const KFElementResult* kfresult )
    {
        ...
        kffunction->_function( kfentity, modulename, moduleid, kfresult );
    }
}